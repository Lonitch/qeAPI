...
5. Create a `inputdir` folder to store all your input file. In the same folder, create shortcuts to your QE executable by using the following command(in your `inputdir` folder):
