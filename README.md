...
`mpirun ./pw.x -npool 8 -in xxxx.in > xxxx.out`
...
1. `#SBATCH N 4` and `#SBATCH n 14` set number of computation nodes and number of CPU cores you want to use for the calculation.
